...
CKEDITOR.editorConfig = function( config )
{
  ...
  config.filebrowserBrowseUrl = "/links.html'";

  // The location of an external file browser, that should be launched when "Browse Server" button is pressed in the Flash dialog.
  // config.filebrowserFlashBrowseUrl = "/flash.html'";
  ...
  config.filebrowserImageBrowseUrl = "/images.html";

  // The location of a script that handles file uploads in the Image dialog.
  config.filebrowserImageUploadUrl = "/images.html";

  // The location of a script that handles file uploads.
  config.filebrowserUploadUrl = "/files.html";
  ...
  config.toolbar_comment = [
    { name: 'basicstyles', groups: [ 'clipboard', 'undo', 'selection', 'spellchecker' ], items: [ 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo', '-', 'SelectAll', '-', "Scayt" ] },
    { name: 'formatting', groups: [ 'basicstyles', 'cleanup' ], items: [ 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'RemoveFormat' ] }
  ];

  config.toolbar_event = [
    { name: 'basicstyles', groups: [ 'basicstyles', 'cleanup' ], items: [ 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'RemoveFormat' ] },
    { name: 'clipboard', groups: [ 'clipboard', 'undo', 'spellchecker' ], items: [ 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo', '-', 'SelectAll', '-', "Scayt" ] },
